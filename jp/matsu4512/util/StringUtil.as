package jp.matsu4512.util
{
	...
	{
		static private const BAD_VARIABLE_NUMBER : String = "The number of variables to be replaced and template holes don't match";
		static private const STRING_FORMATTER : String = "s";
		static private const FLOAT_FORMATER : String = "f";
		static private const INTEGER_FORMATER : String = "d";
		static private const OCTAL_FORMATER : String = "o";
		static private const HEXA_FORMATER : String = "x";
		static private const DATES_FORMATERS : String = "aAbBcDHIjmMpSUwWxXyYZ";
		static private const DATE_DAY_FORMATTER : String = "D";
		static private const DATE_FULLYEAR_FORMATTER : String = "Y";
		static private const DATE_YEAR_FORMATTER : String = "y";
		static private const DATE_MONTH_FORMATTER : String = "m";
		static private const DATE_HOUR24_FORMATTER : String = "H";
		static private const DATE_HOUR_FORMATTER : String = "I";
		static private const DATE_HOUR_AMPM_FORMATTER : String = "p";
		static private const DATE_MINUTES_FORMATTER : String = "M";
		static private const DATE_SECONDS_FORMATTER : String = "S";
		static private const DATE_TOLOCALE_FORMATTER : String = "c";
		static private var version : String = "$Id$";
		
		static public function printf(raw : String, ...rest) : String{
